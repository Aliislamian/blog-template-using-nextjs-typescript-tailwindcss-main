...
export const Ali: IAuthor = {
    ...
    social: [
        {
            icon: <AiFillGithub />,
            link: 'https://github.com/Aliislamian'
        },
        {
            icon: <AiFillLinkedin />,
            link: 'https://www.linkedin.com/in/ali-akbar-bbaa40222'
        },
    ]
}

export const Anees: IAuthor = {
    name: "Anees",
    ...
    social: [
        {
            icon: <AiFillGithub />,
            link: 'https://github.com/Anees201173'
        },
        {
            icon: <AiFillLinkedin />,
            link: 'https://www.linkedin.com/in/ali-akbar-bbaa40222'
...
export const PRIMARY_NAV: iNavSetup = {
    ...
    socials: [
        ...
        {
            link: 'https://www.instagram.com/aliislamian/',
            icon: <AiFillInstagram />
        },
        {
            link: 'https://twitter.com/AliAkba59242344',
